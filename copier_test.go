...
func TestCopySameStructWithPointerField(t *testing.T) {
	...
	user := &User{Birthday: &currentTime, Name: "conku", Nickname: "conku", Age: 18, FakeAge: &fakeAge, Role: "Admin", Notes: []string{"hello world", "welcome"}, flags: []byte{'x'}}
	newUser := &User{}
...
func TestCopyStruct(t *testing.T) {
	var fakeAge int32 = 12
	user := User{Name: "conku", Nickname: "conku", Age: 18, FakeAge: &fakeAge, Role: "Admin", Notes: []string{"hello world", "welcome"}, flags: []byte{'x'}}
	employee := Employee{}
...
func TestCopyFromStructToSlice(t *testing.T) {
	user := User{Name: "conku", Age: 18, Role: "Admin", Notes: []string{"hello world"}}
	employees := []Employee{}
...
func TestCopyFromSliceToSlice(t *testing.T) {
	users := []User{{Name: "conku", Age: 18, Role: "Admin", Notes: []string{"hello world"}}, {Name: "conku2", Age: 22, Role: "Dev", Notes: []string{"hello world", "hello"}}}
	employees := []Employee{}
...
func TestCopyFromSliceToSlice2(t *testing.T) {
	users := []*User{{Name: "conku", Age: 18, Role: "Admin", Notes: []string{"hello world"}}, nil}
	employees := []Employee{}
